...
public class EmpresaDescuentoAdapter extends PagerAdapter {
    Context mContext ;
    List<EmpresaAsociada> empresaAsociadas ;
    Main_User_Activity activity;
    Fragment fragment;
    public EmpresaDescuentoAdapter(Context mContext, List<EmpresaAsociada> empresaAsociadas,Main_User_Activity activity) {
