...
public class RestaurantesDescuentoAdapter extends PagerAdapter {
    Context mContext ;
    List<EmpresaAsociada> empresaAsociadas ;
    private Main_User_Activity activity;
    private Fragment fragment;
    public RestaurantesDescuentoAdapter(Context mContext, List<EmpresaAsociada> empresaAsociadas,Main_User_Activity activity) {
